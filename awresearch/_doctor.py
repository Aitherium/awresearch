"""Stack-aware `doctor` for awresearch.
...
interesting failures live BETWEEN them. "awresearch is installed" is not the useful
fact -- "awresearch is installed and the thing it pairs with is not" is. This reports
...
def _local_checks() -> "list[str]":
    ...
    from the registry, but it does not know what awresearch needs at runtime, and a
